...
<div class="box-positon">
	...
	<form class="ropt">
		<input class="add" type="button" value="添加" onclick="window.location.href='/ad/toAdd.action?positionId=${positionId}'"/>
	</form>
	<div class="clear"></div>
</div>
<div class="body-box">
	...
	<tbody class="pn-ltbody">
		...
		<c:forEach items="${list }" var="ad">
			...
			<tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'"
				...
				<td align="center"><img width="144" height="45"
					src="${ad.picture }"></td>
				<td align="center">${ad.width }</td>
				<td align="center">${ad.height }</td>
				<td align="center"><a class="pn-opt" href="#">查看</a> | <a
					class="pn-opt" href="#">修改</a> | <a class="pn-opt"
					onclick="if(!confirm('您确定删除吗？')) {return false;}" href="#">删除</a>
					| <a class="pn-opt" href="../sku/list.jsp">库存</a></td>
			</tr>
		</c:forEach>
	</tbody>
</table>
